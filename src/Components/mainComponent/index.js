...
function MainComponent() {
  return (
    ...
    <div className='container'>
        ...
        >
          Hi, I am vaibhav Agnihotri. A passionate front-end developer based on indore, india </motion.p>
          <motion.div
             initial={{ opacity: 0, x: -200 }}
             animate={{ opacity: 1, x: 0 }}
             transition={{ delay: 1.7, duration: 1 }}
          >
              <span ><GitHubIcon className='link'/></span>
              <span > <LinkedInIcon className='link'/></span>
          </motion.div>
         
        </div>
        <motion.div className='img-icon'
            initial={{ opacity: 0, y: -200 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay:1.8, duration: 1 }}
        >
            <img src='https://smartslider3.com/wp-content/uploads/slider560/portfolio.png' alt='image'/>
        </motion.div>
    </div>
        ...
        >
            <div className='p-title'><span><LayersRoundedIcon  className='layer-icon' /></span>
            <p> Tech Stack  </p>
            </div>
